...
|---|---|---|
| **Canvas FX** | 77 interactive background animations | `.js` |
| **CSS Presets** | 14 styling presets (glassmorphism, Neon Cyberpunk, and more) | `.css` |
| **Themes** | 27 complete multi-mode theme configurations | `.json` |
