...
function animate() {
  ...
  requestAnimationFrame(animate);
                ...
                <details class="doc-accordion">
                    <summary>15. Troubleshooting &amp; FAQ <i data-icon="chevron"></i></summary>
                    <div class="doc-inner">
                ...
                <details class="doc-accordion">
                    <summary>16. Uninstallation &amp; Complete Removal <i data-icon="chevron"></i></summary>
                    <div class="doc-inner">
 ...
 'owui_theme_last_metadata', 'owui_theme_valve_no_canvas'].forEach(k =&gt; {
  localStorage.removeItem(k); console.log('Purged: ' + k);
                ...
                <details class="doc-accordion" open>
                    <summary>17. Portability & Backups <i data-icon="chevron"></i></summary>
                ...
                <details class="doc-accordion">
                    <summary style="color: #ef4444;">18. Danger Zone <i data-icon="chevron"></i></summary>
                    <div class="doc-inner" style="display:flex; flex-direction:column; align-items:center; gap:16px;">
