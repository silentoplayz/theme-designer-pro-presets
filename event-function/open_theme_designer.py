                        ...
                        <table class="doc-table-compact">
                            ...
                            <tbody>
                                <tr style="border-bottom: 1px solid var(--border);">
                                    ...
                                    <td>Fired once on startup. <code>canvas</code> is an <code>OffscreenCanvas</code> transferred via <code>postMessage</code>. Call <code>canvas.getContext('2d')</code> to obtain your drawing context. <code>width</code> and <code>height</code> are the initial viewport dimensions. <code>env</code> provides runtime context: <code>{ authToken, baseUrl, locale, timezone }</code>.</td>
                                </tr>
                                <tr style="border-bottom: 1px solid var(--border);">
