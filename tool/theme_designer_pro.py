...
"""
    ...
    async def apply_theme(
        ...
        return await self.launch_theme_creator(__user__=__user__)

    async def launch_theme_creator(self, __user__: dict = {}) -> HTMLResponse:
        """
...
<div id="sandbox-warning" style="display:flex; flex-direction: row; align-items: center; justify-content: flex-start; padding: 16px 20px; background: rgba(24, 24, 27, 0.95); border: 1px solid rgba(239, 68, 68, 0.5); border-radius: 14px; margin: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.5); width: calc(100% - 32px); max-width: 600px; box-sizing: border-box;">
    ...
    <div>
        ...
        <div style="font-size: 0.8rem; color: #e4e4e7; line-height: 1.4;">
            Enable <b>"Allow iframe same origin"</b> in <b>Settings &gt; Interface &gt; Sandbox</b>.<br>
            ...
            <div class="docs-container">
                ...
                <details class="doc-accordion">
                    ...
                    <div class="doc-inner">
                        ...
                        <ul>
                            <li><b>Sandbox Mode:</b> Enable <b>"Allow iframe same origin"</b> in <i>Settings &gt; Interface &gt; Sandbox</i> to allow theme injection.</li>
  ...
  requestAnimationFrame(animate);
                ...
                <details class="doc-accordion">
                    ...
                    <div class="doc-inner">
                        ...
                        <ul>
                            <li><b>Universal Importing:</b> You can click any Import icon, or simply <b>drag and drop</b> <code>.json</code>, <code>.css</code>, or <code>.js</code> files anywhere onto the application. The bootloader automatically routes the files to their correct galleries.</li>
                ...
                <details class="doc-accordion">
                    ...
                    <div class="doc-inner">
                        ...
                        <h4>How It Works</h4>
                        <p>When the gradient is enabled (with at least 2 color stops), the tool automatically generates a <i>Structural Layer</i> that makes all layout containers transparent so the gradient shows through. It also adds semi-opaque backdrop-blur rules to the sidebar and textarea for readability, and overrides the chat overlay for proper blending.</p>
                ...
                <details class="doc-accordion">
                    ...
                    <div class="doc-inner">
                        ...
                        <div class="doc-table-wrap">
                            <table class="doc-table">
                                ...
                                <tbody>
                                    ...
                                    <tr><td><b>4. Structural Transparency</b></td><td>—</td><td>CSS rules that set <code>background-color: transparent</code> and <code>background-image: none</code> on <code>#app</code>, <code>main</code>, <code>nav</code>, <code>.sticky</code>, <code>[class*="bg-gray-"]</code>, <code>[class*="bg-white"]</code>, and other layout containers — but explicitly <b>excludes</b> interactive elements (<code>button</code>, <code>a</code>, <code>input</code>, <code>select</code>).</td></tr>
                        ...
                        <p>If neither is active, the tool emits simple opaque <code>background-color</code> rules for <code>body</code>, <code>#sidebar</code>, and <code>textarea</code> — no transparency is applied.</p>
                        ...
                        <ol style="font-size: 0.72rem; line-height: 1.7; padding-left: 18px;">
                            ...
                            <li><b>Structural Background Rules</b> — transparent or opaque <code>body</code>/<code>#sidebar</code>/<code>textarea</code> rules</li>
                ...
                <details class="doc-accordion">
                    ...
                    <div class="doc-inner">
                        ...
                        <ul>
                            ...
                            <li><b>I get a "Sandbox Configuration Required" error.</b> You must enable the <b>Allow Same Origin</b> iframe sandbox flag in your Admin Settings. Go to <i>Settings &gt; Admin Settings &gt; Interface</i>, scroll to the <b>Artifacts</b> section, and toggle <b>ON</b>: <code>iframe Sandbox: Allow Same Origin</code>. Save and refresh.</li>
                ...
                <details class="doc-accordion">
                    ...
                    <div class="doc-inner">
                        ...
                        <p>The easiest way is to use the <b>Factory Reset</b> button in the <b>Danger Zone</b> section below (Section 18). Alternatively, open your Open WebUI instance, press <b>F12</b> to open Developer Tools, go to the <b>Console</b> tab, and paste:</p>
    ...
    function generateCoreCSS() {
        ...
        const getBgRules = (mode, selector, bgBody, bgSidebar, bgTextarea) => {
            ...
            if (hasCanvas || hasGradient) {
                const noBtn = ':not(button):not(a):not(input):not(select)';
                return `
...
${selector} #app, ${selector} .app, ${selector} #auth-container { background-color: transparent !important; background-image: none !important; position: relative; }
${selector} > body > div, ${selector} main, ${selector} #app > div { background-color: transparent !important; background-image: none !important; }
${selector} [class*="bg-gray-"]${noBtn}, ${selector} [class*="bg-white"]${noBtn} { background-color: transparent !important; background-image: none !important; }
${selector} .message-content { background-color: transparent !important; }
${selector} nav, ${selector} .sticky, ${selector} [class*="bg-gradient"] { background-color: transparent !important; background-image: none !important; }
${selector} #sidebar { background-color: var(${bgSidebar}) !important; }
${selector} #sidebar * { background-color: revert-layer; }
